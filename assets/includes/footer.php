...
<div class="mobile-nav-footer container container full-width flex">
	<div class="flex flex-column mobile-footer-button padding-md centered-contents"><a href="#top"><i class="fa fa-home" aria-hidden="true"></i><br></a></div>
	<div class="flex flex-column mobile-footer-button padding-md centered-contents"><a href="tel:<?php echo $phone; ?>"><i class="fa fa-phone" aria-hidden="true"></i><br></a></div>
	<div class="flex flex-column mobile-footer-button padding-md centered-contents"><a href="<?php echo $app; ?>?r=<?php echo $origin; ?>"><i class="fa fa-plus-circle" aria-hidden="true"></i><br></a></div>
	<div class="flex flex-column mobile-footer-button mobile-footer-apply centered-contents contrast-bg flex2"><a href="#quickApp"><i class="fa fa-sign-in" aria-hidden="true"></i><br></a></div>
</div>
